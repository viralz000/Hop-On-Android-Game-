...
public class Level11 extends AppCompatActivity  implements View.OnTouchListener {
    ...
    final int map_val[][] = {{28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            ...
            {28, 28, 28, 14, 21, 14, 28, 14, 24, 14, 28, 28, 28},
            ...
            {28, 14, 30, 14, 28, 28, 28, 28, 28, 14, 0, 14, 28},
...
//                                            ImageView failed = (ImageView)
                                    ...
                                    if (customer) {
                                        ...
                                        if (house) {
                                            startActivity(new Intent(Level11.this, Level12.class));
                                        }
                                    }
                                    break;
                                }
                                ...
                                if (map_val[j][i-1] >= 5 && map_val[j][i-1] <= 19) {
                                    ...
                                    for (int h = 1; h<stack.size(); h++) {
                                        if (grids.get(arr_ind1) == stack.get(h)) {
                                            Toast.makeText(getApplicationContext(), "awaga", Toast.LENGTH_LONG).show();
                                            break;
                                        }
                                    }

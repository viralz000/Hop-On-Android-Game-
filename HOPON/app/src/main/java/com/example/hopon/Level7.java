...
public class Level7 extends AppCompatActivity  implements View.OnTouchListener {
    ...
    final int map_val[][] = {{28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            ...
            {28, 0, 0, 14, 31, 14, 0, 14, 0, 14, 0, 0, 28},
    ...
    public boolean onTouch(View v, MotionEvent me) {
        ...
        if (me.getAction() == MotionEvent.ACTION_DOWN) {
            switch(v.getId()) {
                case R.id.backk:
                    startActivity(new Intent(Level7.this, Stage1.class));
                    break;
                case R.id.retry:
                    startActivity(new Intent(Level7.this, Level7.class));
                    break;
                case R.id.actionup:
                    int arr_ind = 0;
                    boolean done = false;
                                ...
                                if (map_val[j - 1][i] >= 5 && map_val[j - 1][i] <= 19) {
                                    ...
                                    for (int h = 1; h<stack.size(); h++) {
                                        if (grids.get(arr_ind) == stack.get(h)) {
                                            startActivity(new Intent(Level7.this, Level7failed.class));
                                            break;
                                        }
                                    }
                                    ...
                                    if (customer || customer2 || customer3) {
                                        ...
                                        if (house && customer2 && customer3 && customer) {
                                            startActivity(new Intent(Level7.this, Level7success.class));
                                        }
                                    }
                                    break;
                                }
                            ...
                            if (grids.get(arr_ind1).getX() == motor.getX() && grids.get(arr_ind1).getY() == motor.getY()) {
                                if (map_val[j][i-1] >= 5 && map_val[j][i-1] <= 19) {
                                    ...
                                    if (map_val[j][i-1] == 13 && map_val[j-1][i-1] == 31) {
                                        ...
                                        replace3++;
                                        if (replace3 == 1) {
                                            grids.get(108).setImageResource(images[map_val[j-1][i-3]]);
                                        }
                                    }
                                    if (map_val[j-1][i-1] == 23 && customer && customer2 && customer3) {
                                        house = true;
                                    }
                                    for (int h = 1; h<stack.size(); h++) {
                                        b = h;
                                        if (grids.get(arr_ind1) == stack.get(h-1)) {
                                            startActivity(new Intent(Level7.this, Level7failed.class));
                                            break;
                                        }
                                    }
                                    ...
                                    if (customer || customer2 || customer3) {
                                        ...
                                        if (house && customer2 && customer3 && customer) {
                                            if (grids.get(arr_ind1) == stack.get(b-1)) {
                                                startActivity(new Intent(Level7.this, Level7failed.class));
                                            }
                                            else {
                                                startActivity(new Intent(Level7.this, Level7success.class));
                            ...
                            if (grids.get(arr_ind2).getX() == motor.getX() && grids.get(arr_ind2).getY() == motor.getY()) {
                                if (map_val[j][i+1] >= 5 && map_val[j][i+1] <= 19) {
                                    ...
                                    if (customer || customer2 || customer3) {
                                        ...
                                        if (house && customer && customer2 && customer3) {
                                            startActivity(new Intent(Level7.this, Level7success.class));
                                        }
                                    }
                                    break;

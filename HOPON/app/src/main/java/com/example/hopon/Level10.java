...
public class Level10 extends AppCompatActivity  implements View.OnTouchListener {
    ...
    final int map_val[][] = {{28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            ...
            {28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            {28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            {28, 5, 13, 6, 28, 28, 28, 28, 28, 5, 13, 6, 28},
            {28, 14, 20, 14, 28, 28, 28, 28, 28, 14, 0, 14, 28},
            {28, 8, 13, 19, 13, 6, 28, 5, 13, 19, 13, 7, 28},
            {28, 28, 28, 14, 0, 14, 28, 14, 24, 14, 28, 28, 28},
            {28, 28, 5, 17, 13, 19, 13, 19, 13, 17, 6, 28, 28},
            {28, 28, 14, 30, 0, 14, 31, 14, 27, 0, 14, 28, 28},
            {28, 28, 8, 15, 13, 19, 13, 19, 13, 15, 7, 28, 28},
            {28, 28, 28, 14, 0, 14, 28, 14, 26, 14, 28, 28, 28},
            {28, 5, 13, 19, 13, 7, 28, 8, 13, 19, 13, 6, 28},
            {28, 14, 0, 14, 28, 28, 28, 28, 28, 14, 0, 14, 28},
            {28, 8, 13, 7, 28, 28, 28, 28, 28, 8, 13, 7, 28},
            {28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            {28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            {28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
            {28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        motorright = getResources().getDrawable(R.drawable.yellowtopsingleright);
        motorleft = getResources().getDrawable(R.drawable.yellowtopsingleleft);
        motordown = getResources().getDrawable(R.drawable.yellowtopsingledown);
        motorup = getResources().getDrawable(R.drawable.yellowtopsingleup);
        motortwoup = getResources().getDrawable(R.drawable.yellowtoptwoup);
        motortwoleft = getResources().getDrawable(R.drawable.yellowtoptwoleft);
        motortworight = getResources().getDrawable(R.drawable.yellowtoptworight);
        motortwodown = getResources().getDrawable(R.drawable.yellowtoptwodown);
    ...
    public boolean onTouch(View v, MotionEvent me) {
        ...
        if (me.getAction() == MotionEvent.ACTION_DOWN) {
            switch(v.getId()) {
                case R.id.backk:
                    startActivity(new Intent(Level10.this, Stage1.class));
                    break;
                case R.id.retry:
                    startActivity(new Intent(Level10.this, Level10.class));
                    break;
                case R.id.actionup:
                    int arr_ind = 0;
                    boolean done = false;
                        ...
                        for (int i = 0; i < CURR_COL; i++) {
                            if (grids.get(arr_ind).getX() == motor.getX() && grids.get(arr_ind).getY() == motor.getY()) {
                                if (map_val[j - 1][i] >= 5 && map_val[j - 1][i] <= 19) {
                                    if (map_val[j-1][i] == 13 && map_val[j-2][i] == 31) {
                                        customer = true;
                                        replace++;
                                        if (replace == 1) {
                                            grids.get(136).setImageResource(images[map_val[j - 1][i]]);
                                        }
                                    }
                                    if (map_val[j-1][i] == 15 && map_val[j-2][i] == 30) {
                                        customer2 = true;
                                        replace2++;
                                        if (replace2 == 1) {
                                            grids.get(133).setImageResource(images[map_val[j - 1][i]]);
                                        }
                                    }
                                    if (map_val[j-2][i] == 24 && customer && customer2) {
                                        house = true;
                                    }
                                    for (int h = 1; h<stack.size(); h++) {
                                        if (grids.get(arr_ind) == stack.get(h)) {
                                            startActivity(new Intent(Level10.this, Level10failed.class));
                                            break;
                                        }
                                    }
                                    ...
                                    if (customer || customer2) {
                                        ...
                                        if (house) {
                                            startActivity(new Intent(Level10.this, Level10success.class));
                                        }
                                    }
                                    break;
                                }
                        ...
                        for (int i = 0; i < CURR_COL; i++) {
                            if (grids.get(arr_ind1).getX() == motor.getX() && grids.get(arr_ind1).getY() == motor.getY()) {
                                if (map_val[j][i-1] >= 5 && map_val[j][i-1] <= 19) {
                                    if (map_val[j][i-1] == 13 && map_val[j-1][i-1] == 31) {
                                        customer = true;
                                        replace++;
                                        if (replace == 1) {
                                            grids.get(136).setImageResource(images[map_val[j-1][i+2]]);
                                        }
                                    }
                                    if (map_val[j][i-1] == 15 && map_val[j-1][i-1] == 30) {
                                        customer2 = true;
                                        replace2++;
                                        if (replace2 == 1) {
                                            grids.get(133).setImageResource(images[map_val[j-1][i]]);
                                    ...
                                    if (map_val[j][i-1] == 13 && map_val[j-1][i-1] == 24 && customer && customer2) {
                                        house = true;
                                    }
                                    for (int h = 1; h<stack.size(); h++) {
                            ...
                            if (grids.get(arr_ind2).getX() == motor.getX() && grids.get(arr_ind2).getY() == motor.getY()) {
                                if (map_val[j][i+1] >= 5 && map_val[j][i+1] <= 19) {
                                    if (map_val[j][i+1] == 13 && map_val[j-1][i+1] == 31) {
                                        ...
                                        replace++;
                                        if (replace == 1) {
                                            grids.get(136).setImageResource(images[map_val[j - 1][i-1]]);
                                        }
                                    }
                                    if (map_val[j][i+1] == 15 && map_val[j-1][i+1] == 30) {
                                        customer2 = true;
                                        replace2++;
                                        if (replace2 == 1) {
                                            grids.get(133).setImageResource(images[map_val[j - 1][i+2]]);
                                        }
                                    }
                                    if (map_val[j][i+1] == 13 && map_val[j-1][i+1] == 24 && customer && customer2) {
                                        house = true;
                        ...
                        for (int i = 0; i < CURR_COL; i++) {
                            if (grids.get(arr_ind3).getX() == motor.getX() && grids.get(arr_ind3).getY() == motor.getY()) {
                                if (map_val[j+1][i] >= 5 && map_val[j+1][i] <= 19 ) {
                                    ...
                                    if (map_val[j+1][i] == 15 && map_val[j+2][i] == 24 && customer && customer2) {
                                        house = true;
                                    }
